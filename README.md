...
function buildExif(m){ const zeroth={}, exif={}, gps={}; if(m.title) zeroth[piexif.ImageIFD.ImageDescription]=m.title; if(m.author) zeroth[piexif.ImageIFD.Artist]=m.author; if(m.copyright) zeroth[piexif.ImageIFD.Copyright]=m.copyright; if(m.comment) exif[piexif.ExifIFD.UserComment]=m.comment; if(m.date){ exif[piexif.ExifIFD.DateTimeOriginal]=m.date.replaceAll('-',':')+' 00:00:00'; }
